            ...
            <div className="ot-dealer-row bj-dealer-row">
              <div className="ot-hand dealer">
                ...
                <div className="ot-cards">
                  ...
                  {/* Render the hidden card only after the server has actually dealt it. Previously
                      it appeared alongside the upcard before the second dealer draw occurred. */}
                  {snapshot.dealerHoleHidden && snapshot.dealerHoleDealt && <span className="playing-card" ref={(el) => void applyShoeFlight(el)}><span className="playing-card-inner"><span className="playing-card-back"><CardBackFace /></span></span></span>}
                </div>
              </div>
            </div>
